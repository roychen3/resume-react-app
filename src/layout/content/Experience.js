    ...
    return (
        <StyledExperienceNode $backgroundImg={data.backgroundImg}>
            ...
            <StyledExperienceNodeContent>
                ...
                <p>
                    {`${intl.formatMessage({ id: 'experience.useSkill' })}${data.useSkill}`}
                </p>
            </StyledExperienceNodeContent>
...
const Experience = () => {
    ...
    const experienceData = [
        ...
        },
        {
            ...
            companyName: intl.formatMessage({ id: 'experience.graduationTopic.companyName' }),
            jobTitle: intl.formatMessage({ id: 'experience.graduationTopic.jobTitle' }),
            period: intl.formatMessage({ id: 'experience.graduationTopic.period' }),
            instruction: intl.formatMessage({ id: 'experience.graduationTopic.instruction' }),
